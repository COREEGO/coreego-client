import { Box, Button, Container, Link as ChakraLink, Stack, Icon } from "@chakra-ui/react"
...
import { ICON_SIZE_HEADER, CONTAINER_SIZE } from "../../utils/config";
...
const HeaderNavigation = () => (
    <Box sx={{position: 'sticky', top: 0}} boxShadow="0 0 5px gray" py="5">
