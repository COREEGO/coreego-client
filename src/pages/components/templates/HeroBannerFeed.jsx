...
const HeroBannerFeed = (props) => {
	return (
		<Box
			...
			>
				<Container>
					<Grid flexDirection={`row${props.imageDirection === 'start' && '-reverse' }`} container alignItems="center">
						<Grid item xs={12} md={6}>
							<Stack maxWidth="100%" spacing={2} alignItems="flex-start">
								...
								<Button color={props.theme == 'red' ? 'error' : 'primary' } variant="contained" startIcon={<ADD_ICON />}>
									{props.buttonLabel}
								</Button>
                                </NavLink>
							</Stack>
						...
						>
							<img
								...
								width={350}
								style={{
									boxShadow: `${props.imageDirection == 'start' ? '-20px' : '20px'} 20px 4px var(--coreego-${props.theme})`,
									marginRight: `${props.imageDirection == 'end' && '20px' }`,
									marginLeft: `${props.imageDirection == 'start' && '20px'}`,
									marginBottom: 20,
									borderRadius: 5,
									objectFit: "cover",
